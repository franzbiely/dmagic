...
include(WP_MLM_PLUGIN_DIR . '/functions/wp-mlm-db-functions.php');
...
function wpmlm_register_user_html_page() {
    ...
    <div class="panel-border-heading">
        <h3><?php _e('WP MLM User Registration','wpmlm-unilevel'); ?></h3>
    </div>
    <div class="ioss-mlm-menu panel-border">
        ...
        <label class="tab_class" for="ioss-mlm-tab2"><?php _e('My Profile','wpmlm-unilevel'); ?></label>      
        ...
        <label class="tab_class" for="ioss-mlm-tab5"><?php _e('Bonus Details','wpmlm-unilevel'); ?></label>
        <input id="ioss-mlm-tab6" class="tab_class" type="radio" name="tabs">
        <label class="tab_class" for="ioss-mlm-tab6"><?php _e('Referral Details','wpmlm-unilevel'); ?></label>
        ...
        <div class="col-md-12 panel-border">
            <div class="col-md-6 regOuterDiv">
                <div class="col-md-12">
                    ...
                    <h4 class="text-center"><?php _e('Please complete the registration to join the MLM network','wpmlm-unilevel'); ?></h4>
                    <form id="regForm" method="post" action="" style="<?php echo $form_style; ?>">
                        ...
                        if ($reg_pack_type != 'with_out_package') {
                            ...
                            <div class="tab"><h1><?php echo $step1; ?>: <?php _e('Select Package','wpmlm-unilevel'); ?></h1>
                                <?php
                                ...
                                if (count($packages) > 0) {
                                    ...
                                    <p><select name="package_select" oninput="this.className = ''" id="package_select">
                                            <option value="" tabindex="1"><?php _e('Select Package','wpmlm-unilevel'); ?></option>
                                            <?php
                        ...
                        <div class="tab"><h1><?php echo $step2; ?>: User Info</h1>
                            <p><input type="text" oninput="this.className = 'required-field'" name="sname" id="sname"  placeholder="* <?php _e('Enter Sponsor Name','wpmlm-unilevel'); ?>"  tabindex="2" class="required-field" ></p>                
                            <p><input type="text" oninput="this.className = 'required-field'" name="fname" id="fname" placeholder="* <?php _e('Enter First Name','wpmlm-unilevel'); ?>" tabindex="3" class="required-field" ></p>
                            <p><input type="text"  name="lname" id="lname" placeholder="<?php _e(' Enter Last Name','wpmlm-unilevel'); ?>" tabindex="4" ></p>

                            <p><input type="text" oninput="this.className = 'required-field'" name="address1" id="address1" placeholder="* <?php _e('Enter Address','wpmlm-unilevel'); ?>" tabindex="5" class="required-field"></p>

                            <p oninput="this.className = 'required-field'" name="dob" id="dob"  class="input-group date" data-date-format="yyyy-mm-dd">
                                <input class="form-control date_of_birth required-field" type="text" readonly name="date_of_birth" placeholder="* <?php _e('Enter DOB','wpmlm-unilevel'); ?>" tabindex="6"  />
                            ...
                            <p><select oninput="this.className = 'required-field'" name="country" id="country" style="width:100%; background-color: #fff;" tabindex="7" class="required-field" >
                                    ...
                                    echo '<option value=""> * '?><?php _e("Choose Country","wpmlm-unilevel").'</option>';
                                    foreach ($results as $res) {
                                        echo '<option value="' . $res->id . '">' . $res->name . '</option>';
                                    }
                                    ?>
                                </select></p>
                            <p><input type="text" oninput="this.className = ''" name="state" id="state" placeholder=" <?php _e('Enter State','wpmlm-unilevel'); ?>" tabindex="8"></p>


                            <p><input type="text" oninput="this.className = ''" name="city" id="city" placeholder=" <?php _e('Enter City','wpmlm-unilevel'); ?>" tabindex="9"></p>
                            <p><input type="number" oninput="this.className = ''" name="zip" id="zip" placeholder=" <?php _e('Enter Zip Code','wpmlm-unilevel'); ?>" onkeypress="return isNumberKey(event)" tabindex="8"></p>


                            <p><input type="number" oninput="this.className = 'required-field'" name="contact_no" id="contact_no" placeholder="* <?php _e('Enter Contact No','wpmlm-unilevel'); ?>" onkeypress="return isNumberKey(event)" tabindex="10" class="required-field"></p>
                        ...
                        <div class="reg-next-prev-div-outer">
                            ...
                            <div class="reg-next-prev-div">
                                <button type="button"  class="btn" id="prevBtn" onclick="nextPrev(-1)"><?php _e('Previous','wpmlm-unilevel'); ?></button>
                                <button type="button"  class="btn btn-danger" id="nextBtn"   onclick="nextPrev(1)" tabindex="18"><?php _e('Next','wpmlm-unilevel'); ?></button>
                            </div>
                        </div>
